    ...
    <div>
      <div className="flex">
        ...
        <div>
          ...
          <div className="info-popup text-sm">The file should contain only unique records of LGD entities.</div>
        </div>
      </div>

      <input
        className="block w-full mb-2 text-base text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 file:bg-gray-800 file:text-white"
        id="file_input"
        type="file"
        accept=".csv"
